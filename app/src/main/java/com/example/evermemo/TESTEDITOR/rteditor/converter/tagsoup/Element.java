...
public class Element {
    ...
    @Nullable
    private com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.Element theNext; // successor of element
    ...
    @Nullable
    public com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.Element next() {
        return theNext;
    }
    ...
    public void setNext(com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.Element next) {
        theNext = next;
    }
    ...
    public boolean canContain(@NonNull com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.Element other) {
