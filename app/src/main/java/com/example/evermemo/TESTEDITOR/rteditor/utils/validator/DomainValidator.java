 ...
 */
package com.example.evermemo.TESTEDITOR.rteditor.utils.validator;
...
public class DomainValidator implements Serializable {
     ...
     */
    private static final com.example.evermemo.TESTEDITOR.rteditor.utils.validator.DomainValidator DOMAIN_VALIDATOR = new com.example.evermemo.TESTEDITOR.rteditor.utils.validator.DomainValidator(false);
    /**
     * Singleton instance of this validator, which does
     * consider local addresses valid.
     */
    private static final com.example.evermemo.TESTEDITOR.rteditor.utils.validator.DomainValidator DOMAIN_VALIDATOR_WITH_LOCAL = new com.example.evermemo.TESTEDITOR.rteditor.utils.validator.DomainValidator(true);
     ...
     */
    @NonNull
    public static com.example.evermemo.TESTEDITOR.rteditor.utils.validator.DomainValidator getInstance() {
     ...
     */
    @NonNull
    public static com.example.evermemo.TESTEDITOR.rteditor.utils.validator.DomainValidator getInstance(boolean allowLocal) {
        if (allowLocal) {
...
//        java.net.IDN.toASCII(line); // Java 1.6+
    ...
    private static class IDNHolder {
        ...
        private static Method getMethod() {
            try {
                Class clazz = Class.forName("java.net.IDN", false, com.example.evermemo.TESTEDITOR.rteditor.utils.validator.DomainValidator.class.getClassLoader());
