...
public class RTEditorMovementMethod extends ArrowKeyMovementMethod {
    ...
    private static com.example.evermemo.TESTEDITOR.rteditor.RTEditorMovementMethod sInstance;

    public static synchronized MovementMethod getInstance() {
        if (sInstance == null) {
            sInstance = new com.example.evermemo.TESTEDITOR.rteditor.RTEditorMovementMethod();
        }
        return sInstance;
    }
