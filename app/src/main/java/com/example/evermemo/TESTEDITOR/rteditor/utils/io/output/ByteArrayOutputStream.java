 ...
 */
package com.example.evermemo.TESTEDITOR.rteditor.utils.io.output;

import androidx.annotation.NonNull;

import com.example.evermemo.TESTEDITOR.rteditor.utils.io.input.ClosedInputStream;
...
public class ByteArrayOutputStream extends OutputStream {
    ...
    public static InputStream toBufferedInputStream(@NonNull InputStream input)
            throws IOException {
        com.example.evermemo.TESTEDITOR.rteditor.utils.io.output.ByteArrayOutputStream output = new com.example.evermemo.TESTEDITOR.rteditor.utils.io.output.ByteArrayOutputStream();
        output.write(input);
