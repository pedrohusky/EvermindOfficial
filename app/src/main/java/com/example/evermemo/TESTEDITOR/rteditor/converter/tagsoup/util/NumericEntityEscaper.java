...
package com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.util;
...
public class NumericEntityEscaper extends CodePointTranslator {
     ...
     */
    @NonNull
    public static com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.util.NumericEntityEscaper below(final int codepoint) {
     ...
     */
    @NonNull
    public static com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.util.NumericEntityEscaper above(final int codepoint) {
     ...
     */
    @NonNull
    public static com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.util.NumericEntityEscaper between(final int codepointLow, final int codepointHigh) {
        return new com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.util.NumericEntityEscaper(codepointLow, codepointHigh, true);
    }
     ...
     */
    @NonNull
    public static com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.util.NumericEntityEscaper outsideOf(final int codepointLow, final int codepointHigh) {
        return new com.example.evermemo.TESTEDITOR.rteditor.converter.tagsoup.util.NumericEntityEscaper(codepointLow, codepointHigh, false);
    }
