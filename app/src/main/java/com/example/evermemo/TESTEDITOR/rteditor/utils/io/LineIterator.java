 ...
 * or by calling the {@link #close()} or {@link #closeQuietly(com.example.evermemo.TESTEDITOR.rteditor.utils.io.LineIterator)}
...
public class LineIterator implements Iterator<String> {
     ...
     */
    public static void closeQuietly(@Nullable com.example.evermemo.TESTEDITOR.rteditor.utils.io.LineIterator iterator) {
        if (iterator != null) {
            iterator.close();
        }
    }
