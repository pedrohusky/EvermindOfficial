 ...
 */
public class NumberSpan extends com.example.evermemo.TESTEDITOR.rteditor.spans.BaseListItemSpan implements LeadingMarginSpan, RTSpan<Boolean>, RTParagraphSpan<Boolean> {
    ...
    @NonNull
    @Override
    public com.example.evermemo.TESTEDITOR.rteditor.spans.NumberSpan createClone() {
        return new com.example.evermemo.TESTEDITOR.rteditor.spans.NumberSpan(mNr, mGapWidth, mIgnoreSpan);
    }
}
