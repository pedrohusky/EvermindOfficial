...
public class IndentationSpan extends android.text.style.LeadingMarginSpan.Standard implements RTSpan<Integer>, RTParagraphSpan<Integer> {
    ...
    public IndentationSpan(Parcel src) {
        super(null);
        mIndentation = 0;
        mIgnoreSpan = false;
    }
    ...
    @NonNull
    @Override
    public com.example.evermemo.TESTEDITOR.rteditor.spans.IndentationSpan createClone() {
        return new com.example.evermemo.TESTEDITOR.rteditor.spans.IndentationSpan(mIndentation, mIgnoreSpan);
    }
