...
public class BulletSpan extends BaseListItemSpan implements LeadingMarginSpan, RTSpan<Boolean>, RTParagraphSpan<Boolean> {
    ...
    @NonNull
    @Override
    public com.example.evermemo.TESTEDITOR.rteditor.spans.BulletSpan createClone() {
        return new com.example.evermemo.TESTEDITOR.rteditor.spans.BulletSpan(mGapWidth, mIgnoreSpan);
    }
