...
abstract class EverCircularMenu : CompBatMBLayout {
    ...
    private fun addMenuItems(frameLayout: FrameLayout) {
        ...
        val marginsToCompensateCutoff =
            resources.getDimension(R.dimen.margins_to_compensate_cutoff).toInt()
    ...
    fun updateTextureView(startDelay: Long) {
        val updateTextureViewAnimation =
            ValueAnimator.ofFloat(0f, 0f).setDuration(startDelay + closeAnimationDuration)
    ...
    protected fun animatePosition(
        ...
        val translationX =
            ObjectAnimator.ofFloat(view, View.TRANSLATION_X, view.translationX, x).setDuration(
                duration
            )
        ...
        val translationY =
            ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, view.translationY, y).setDuration(
                duration
            )
