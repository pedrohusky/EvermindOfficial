...
public class EverExpandArrow extends View {
    ...
    public EverExpandArrow(@NonNull Context context) {
        this(context, null);
    }

    public EverExpandArrow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EverExpandArrow(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        final long animationDuration;
            ...
            switchColor = true;
            color = Color.BLACK;
            colorMore = Color.BLACK;
            colorLess = Color.BLACK;
            colorIntermediate = -1;
     ...
     */
    public void setState(@EverExpandArrow.State int state, boolean animate) {
        this.state = state;
        if (state == MORE) {
            fraction = 0f;
        } else if (state == LESS) {
