 ...
 */
public class NumberSpan extends com.example.Evermind.TESTEDITOR.rteditor.spans.BaseListItemSpan implements LeadingMarginSpan, RTSpan<Boolean>, RTParagraphSpan<Boolean> {
