...
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.processor.ImageProcessor;
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.processor.ImageProcessor.ImageProcessorListener;
...
class ImageChooserManager extends MediaChooserManager implements ImageProcessorListener {
    ...
    private final ImageChooserListener mListener;
    ...
    private boolean pickPicture() {
        Intent intent = new Intent(Intent.ACTION_GET_CONTENT, null)
                ...
                .setType("image/*");
       // String title = mActivity.getString("aaaaa");
        ...
        try {
            ...
            if (imagePath.exists() && imageFile.createNewFile()) {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                  ...
                  //  uriForCamera = FileProvider.getUriForFile(mActivity, "com.example.Evermind.TESTEDITOR.rteditor.fileprovider", imageFile);
                }
