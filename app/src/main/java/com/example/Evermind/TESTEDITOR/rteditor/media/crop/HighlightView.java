...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(R.drawable.ic_launcher_background);
        mResizeDrawableHeight = resources.getDrawable(R.drawable.ic_launcher_background);
        mResizeDrawableDiagonal = resources.getDrawable(R.drawable.ic_launcher_background);
    }
