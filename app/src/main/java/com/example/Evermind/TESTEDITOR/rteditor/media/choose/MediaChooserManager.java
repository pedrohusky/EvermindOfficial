...
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.processor.MediaProcessor;
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.processor.MediaProcessor.MediaProcessorListener;
...
abstract class MediaChooserManager implements MediaProcessorListener {
    ...
    final transient private MediaChooserListener mListener;
