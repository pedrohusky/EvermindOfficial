...
package com.example.Evermind.TESTEDITOR.rteditor.media;
...
public class MonitoredActivity extends AppCompatActivity {
    ...
    private class Job<T> extends LifeCycleAdapter implements ForegroundJob<T> {
        ...
        private final Runnable mCleanupRunner = new Runnable() {
            public void run() {
                removeLifeCycleListener(com.example.Evermind.TESTEDITOR.rteditor.media.MonitoredActivity.Job.this);
