...
package com.example.Evermind.TESTEDITOR.rteditor.media.choose;
...
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.AudioChooserManager.AudioChooserListener;
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.ImageChooserManager.ImageChooserListener;
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.VideoChooserManager.VideoChooserListener;
import com.example.Evermind.TESTEDITOR.rteditor.media.crop.CropImageActivity;
import com.example.Evermind.TESTEDITOR.rteditor.utils.Constants;
...
public class MediaChooserActivity extends MonitoredActivity implements
    ...
    private static final String PREFIX = com.example.Evermind.TESTEDITOR.rteditor.media.choose.MediaChooserActivity.class.getSimpleName();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (mMediaAction == MediaAction.CAPTURE_PICTURE) {
                    ...
                    Intent intent = new Intent(com.example.Evermind.TESTEDITOR.rteditor.media.choose.MediaChooserActivity.this, CropImageActivity.class)
