...
public class RTTypeface implements Comparable<com.example.Evermind.TESTEDITOR.rteditor.fonts.RTTypeface> {
    ...
    public boolean equals(Object object) {
        if (! (object instanceof com.example.Evermind.TESTEDITOR.rteditor.fonts.RTTypeface)) {
            return false;
        }
        String name = ((com.example.Evermind.TESTEDITOR.rteditor.fonts.RTTypeface)object).getName();
