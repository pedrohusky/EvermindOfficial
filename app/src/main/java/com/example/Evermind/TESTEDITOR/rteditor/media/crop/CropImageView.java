...
package com.example.Evermind.TESTEDITOR.rteditor.media.crop;
...
public class CropImageView extends ImageViewTouchBase {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mBitmapDisplayed.getBitmap() != null) {
            for (com.example.Evermind.TESTEDITOR.rteditor.media.crop.HighlightView hv : mHighlightViews) {
    ...
    private void recomputeFocus(@NonNull MotionEvent event) {
        ...
        for (int i = 0; i < mHighlightViews.size(); i++) {
            ...
            if (edge != com.example.Evermind.TESTEDITOR.rteditor.media.crop.HighlightView.GROW_NONE) {
                if (!hv.hasFocus()) {
                    hv.setFocus(true);
                    hv.invalidate();
                }
        ...
        switch (event.getAction()) {
                    ...
                    for (int i = 0; i < mHighlightViews.size(); i++) {
                        ...
                        if (edge != com.example.Evermind.TESTEDITOR.rteditor.media.crop.HighlightView.GROW_NONE) {
                            ...
                            mMotionHighlightView
                                    .setMode((edge == com.example.Evermind.TESTEDITOR.rteditor.media.crop.HighlightView.MOVE) ? com.example.Evermind.TESTEDITOR.rteditor.media.crop.HighlightView.ModifyMode.Move
                                            : com.example.Evermind.TESTEDITOR.rteditor.media.crop.HighlightView.ModifyMode.Grow);
                            break;
                        }
                    }
                }
            ...
            case MotionEvent.ACTION_UP:
                if (cropImage.mWaitingToPick) {
                    ...
                    mMotionHighlightView.setMode(com.example.Evermind.TESTEDITOR.rteditor.media.crop.HighlightView.ModifyMode.None);
                }
    ...
    public void add(com.example.Evermind.TESTEDITOR.rteditor.media.crop.HighlightView hv) {
