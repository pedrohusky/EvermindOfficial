...
public abstract class Helper {
    ...
    public static float getDisplayDensity() {
        synchronized (com.example.Evermind.TESTEDITOR.rteditor.utils.Helper.class) {
    ...
    public static int getLeadingMarging() {
        if (sLeadingMarging == -1) {
            float density = com.example.Evermind.TESTEDITOR.rteditor.utils.Helper.getDisplayDensity();
