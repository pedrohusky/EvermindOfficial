...
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.processor.VideoProcessor;
import com.example.Evermind.TESTEDITOR.rteditor.media.choose.processor.VideoProcessor.VideoProcessorListener;
import com.example.Evermind.TESTEDITOR.rteditor.utils.Constants.MediaAction;

import java.io.File;

class VideoChooserManager extends com.example.Evermind.TESTEDITOR.rteditor.media.choose.MediaChooserManager implements VideoProcessorListener {
