 ...
 */
class EverGLRenderer implements EverGLAudioVisualizationView.AudioVisualizationRenderer {
    ...
    public EverGLRenderer(@NonNull Context context, EverGLAudioVisualizationView.Configuration configuration) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        layers = new EverGLWaveLayer[configuration.layersCount];
        ...
        for (int i = 0; i < layers.length; i++) {
            ...
            layers[i] = new EverGLWaveLayer(configuration, configuration.layerColors[i], fromY, toY, random);
        }
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (EverGLWaveLayer layer : layers) {
    ...
    @Override
    public void updateConfiguration(@NonNull EverGLAudioVisualizationView.ColorsBuilder builder) {
